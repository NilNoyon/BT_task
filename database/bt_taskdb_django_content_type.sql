...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(7,'BTTaskApp','randomuser'),(5,'contenttypes','contenttype'),(6,'sessions','session');
